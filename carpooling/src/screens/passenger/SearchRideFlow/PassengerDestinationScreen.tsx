...
interface PassengerDestinationScreenProps {
    navigation: any;
}

export const PassengerDestinationScreen: React.FC<PassengerDestinationScreenProps> = ({ navigation }) => {
    const { form, updateForm } = usePassengerRideFlow();
    const quickOptions = ['Tech Park, Whitefield', 'Airport, Bangalore', 'Favorite: Koramangala', 'Recent: HSR Layout'];
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    <Button
                        title="Next"
                        onPress={() => navigation.navigate('PassengerDeparture')}
...
export default PassengerDestinationScreen;
